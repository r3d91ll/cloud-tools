...
class ToolBase(BaseModel):
    ...
    platform: Optional[str] = Field(None, description="Platform the tool runs on (linux, windows, etc.)")
...
class ScriptCreate(ScriptBase):
    ...
    tool_id: Optional[int] = Field(None, description="Optional tool ID to associate with this script")
